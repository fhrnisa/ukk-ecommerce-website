<nav class="fixed top-0 left-0 w-full mx-auto flex justify-between items-center py-5 px-6 md:px-20 bg-blue-200/60 backdrop-blur z-50">
    ...
    <div class="flex gap-4 md:hidden items-center mr-2">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="flex border-1 border-gray-500 rounded-md px-3 py-2 items-center bg-gray-100">
            <form action="{{ route('search') }}" method="GET" class="flex items-center w-full">
                <input type="text" name="searchbar" placeholder="Mau cari apa?" class="outline-none text-sm bg-transparent flex-1">
